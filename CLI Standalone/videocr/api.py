...
def save_subtitles_to_file(
    ...
    with open(file_path, 'w+', encoding='utf-8') as f:
        f.write(get_subtitles(
            ...
            sim_threshold, use_fullframe, det_model_dir, rec_model_dir, cls_model_dir, use_gpu, use_angle_cls, brightness_threshold, similar_image_threshold, similar_pixel_threshold, frames_to_skip, crop_x, crop_y, crop_width, crop_height))
